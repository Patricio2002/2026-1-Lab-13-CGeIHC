...
void Window::ManejaTeclado(GLFWwindow* window, int key, int code, int action, int mode)
{
	...
	if (key == GLFW_KEY_H && theWindow->articulacion3 > -90)
	{
		theWindow->articulacion3 -= 10.0;
	}
	if (key == GLFW_KEY_J && theWindow->articulacion4 < 170)
	{
		theWindow->articulacion4 += 10.0;
	}
	if (key == GLFW_KEY_K && theWindow->articulacion5 > -90)
	{
		theWindow->articulacion5 -= 10.0;
	}
	if (key == GLFW_KEY_L && theWindow->articulacion6 < 170)
	{
		theWindow->articulacion6 += 10.0;
	}
	if (key == GLFW_KEY_C && theWindow->articulacion7 > -90)
	{
		theWindow->articulacion7 -= 10.0;
	}
	if (key == GLFW_KEY_V && theWindow->articulacion8 < 170)
	{
		theWindow->articulacion8 += 10.0;
	}
	if (key == GLFW_KEY_B && theWindow->articulacion9 > -90)
	{
		theWindow->articulacion9 -= 10.0;
	}
	if (key == GLFW_KEY_N && theWindow->articulacion10 < 170)
	{
