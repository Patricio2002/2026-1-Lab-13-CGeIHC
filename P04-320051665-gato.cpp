...
int main()
{
	...
	*/
	...
	glm::mat4 modelaux2(1.0); //base
	glm::mat4 modelaux3(1.0); //cabeza
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//CREACION DEL GATO__________________________________________________________________________________

		//CREANDO EL CUERPO DEL GATO
		...
		color = glm::vec3(0.5f, 0.5f, 0.5f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		model = glm::translate(model, glm::vec3(2.5f, -0.75f, 0.75f));
		...
		color = glm::vec3(0.5f, 0.5f, 0.5f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		model = glm::translate(model, glm::vec3(-4.5f, -0.75f, -0.75f));
